"""
Django settings for lakesofyosemite project.
...
SECRET_KEY =  os.getenv('SECRET_KEY','dev_key_dummy')
...
ROOT_URLCONF = 'lakesofyosemite.urls'
...
WSGI_APPLICATION = 'lakesofyosemite.wsgi.application'
